...
/*const generateOtp = () =>{
    try{
        ...
        return otp // Convert OTP to string format
    } catch (error) {
...
const options = {
    key: fs.readFileSync('C:/Users/leonardo/Desktop/certificate/key.pem'),
    cert: fs.readFileSync('C:/Users/leonardo/Desktop/certificate/cert.pem')
};

const sslServer = https.createServer(options, app);

sslServer.listen(8801, () => {
    console.log('Server running on https://localhost:8801/');
});
...
// Go to the database and use the following command
//ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password By 'slaves123#'